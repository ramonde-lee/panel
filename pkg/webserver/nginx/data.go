...
include /home/www/default/config/shared/*.conf;
server {
    listen 80;
    server_name localhost;
    root /home/www/default/public;
    index index.html;
    # custom configs
    include /home/www/default/config/site/*.conf;
}
`
...
var order = map[string]int{
	...
	"ssl_session_cache":         203,
	"ssl_session_timeout":       204,
